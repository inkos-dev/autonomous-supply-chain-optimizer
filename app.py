...
# This looks for the key you put in the 'Advanced' tab on Streamlit Cloud
...
# Ensure the environment variable is set for the underlying libraries
...
try:
    df_bom = pd.read_csv("bom.csv")
    df_inventory = pd.read_csv("inventory.csv")
    df_suppliers = pd.read_csv("suppliers.csv")
except Exception as e:
    st.error(f"Error loading data files: {e}. Ensure bom.csv, inventory.csv, and suppliers.csv exist.")
    st.stop()
